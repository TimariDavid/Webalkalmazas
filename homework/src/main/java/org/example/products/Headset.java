...
public class Headset extends Product {
    ...
    public Headset(Long id, String productId, String productName, int price, int inStock, String text, String attribute1, String attribute2, String attribute3, String type) {
